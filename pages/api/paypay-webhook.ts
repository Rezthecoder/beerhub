...
import { updateOrderPaymentStatus, updatePaymentRecord, getOrderWithPayments, getLatestPayPayOrder } from '../../lib/products';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // First, try to find the order by searching payments table for this merchantPaymentId
    console.log('🔍 Searching for order with merchantPaymentId:', merchantPaymentId);
    
    // We need to find the order that has a payment record with this merchantPaymentId
